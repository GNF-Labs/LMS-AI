...
CORS(app)  # Add this line to enable CORS for all routes and origins
...
def get_model_recommendations(user_id, item_id):
    try:
        recommended_items = get_single_item_recommendation('data_collect.csv', user_id, item_id)
